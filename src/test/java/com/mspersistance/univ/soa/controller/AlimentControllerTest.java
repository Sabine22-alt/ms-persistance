...
import com.mspersistance.univ.soa.mapper.AlimentMapper;
import com.mspersistance.univ.soa.model.Aliment;
import com.mspersistance.univ.soa.service.AlimentService;
...
class AlimentControllerTest {
    ...
    void setUp() {
        ...
        alimentDTO = new AlimentDTO(1L, "Tomate", null, null, null, null, null, Aliment.CategorieAliment.LEGUME);
    }
    ...
    void getAllAliments_devraitRetournerTousLesAliments() throws Exception {
        ...
        AlimentDTO dto2 = new AlimentDTO(2L, "Carotte", null, null, null, null, null, null);
    ...
    void createAliment_avecDonneesValides_devraitCreerAliment() throws Exception {
        ...
        AlimentDTO savedDTO = new AlimentDTO(3L, "Pomme", null, null, null, null, null, Aliment.CategorieAliment.FRUIT);
    ...
    void createAliment_sansNom_devraitRetourner400() throws Exception {
        AlimentDTO dto = new AlimentDTO(null, null, null, null, null, null, null, Aliment.CategorieAliment.FRUIT);
    ...
    void createAliment_avecNomTropCourt_devraitRetourner400() throws Exception {
        AlimentDTO dto = new AlimentDTO(null, "A", null, null, null, null, null, Aliment.CategorieAliment.FRUIT);
    ...
    void createAliment_avecNomExistant_devraitRetourner409() throws Exception {
        AlimentDTO dto = new AlimentDTO(null, "Tomate", null, null, null, null, null, Aliment.CategorieAliment.LEGUME);
    ...
    void updateAliment_avecDonneesValides_devraitMettreAJour() throws Exception {
        ...
        AlimentDTO updatedDTO = new AlimentDTO(1L, "Tomate cerise", null, null, null, null, null, Aliment.CategorieAliment.FRUIT);
    ...
    void updateAliment_avecIdInexistant_devraitRetourner404() throws Exception {
        AlimentDTO dto = new AlimentDTO(null, "Test", null, null, null, null, null, Aliment.CategorieAliment.FRUIT);
